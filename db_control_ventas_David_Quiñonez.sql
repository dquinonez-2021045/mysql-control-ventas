...
Catedrático: Jorge Luis Pérez Canto
	...
	Nombre alumno:	David Josué André Quiñonez Zeta
	Carné:	2021045
...
-- -----------------------------------------------------
DROP DATABASE IF EXISTS db_control_ventas_david_quiñonez;
CREATE DATABASE IF NOT EXISTS db_control_ventas_david_quiñonez;
USE db_control_ventas_david_quiñonez;
...
-- -------------------------------------------------------------------------
DELIMITER $$
DROP TRIGGER IF EXISTS tr_detalle_compra_before_insert $$
CREATE TRIGGER tr_detalle_compra_before_insert
AFTER INSERT
ON detalle_compras
FOR EACH ROW
BEGIN
...
-- -------------------------------------------------------------------------
DELIMITER $$
DROP TRIGGER IF EXISTS tr_detalle_compra_before_insert2 $$
CREATE TRIGGER tr_detalle_compra_before_insert2
AFTER INSERT
ON detalle_ventas	
FOR EACH ROW
BEGIN
